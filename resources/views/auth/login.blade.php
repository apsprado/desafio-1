    ...
    <div class="col-lg-4 col-md-6 ml-auto mr-auto">
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body">
                    <p class="text-dark mb-2">Sign in with <strong>admin@dixbpo.com</strong> and the password
                    ...
                    <div class="input-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                        ...
                        <input type="email" name="email"
                            ...
                            placeholder="{{ _('Email') }}" value="admin@dixbpo.com">
                    ...
                    <div class="input-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                        ...
                        <input type="password" placeholder="{{ _('Password') }}" name="password"
                            class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" value="12345678">
                        @include('alerts.feedback', ['field' => 'password'])
                    </div>
                </div>
                <div class="card-footer">
                    <button type="submit" href=""
                        class="btn btn-primary btn-lg btn-block mb-3">{{ _('Get Started') }}</button>
                    <div class="pull-left">
                        <h6>
                    ...
                    <div class="pull-right">
                        <h6>
                            <a href="{{ route('password.request') }}"
                                class="link footer-link">{{ _('Forgot password?') }}</a>
                        </h6>
                    </div>
                </div>
            </div>
